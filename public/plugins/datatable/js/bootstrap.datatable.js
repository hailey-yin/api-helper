...
search_html += "_INPUT_";
search_html += '<span class="input-group-btn"><button type="button" data-toggle="dropdown" class="btn btn-success btn-sm btn-square"><i class="fa fa-search"></i></button></span></div>';
$.extend( true, $.fn.dataTable.defaults, {
	"sDom":
